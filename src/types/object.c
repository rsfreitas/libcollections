...
bool cl_object_is_of_type(const cl_object_t *object,
    unsigned int type)
{
    cl_object_s *o;
    bool b;
...
int cl_object_set_equals(cl_object_t *object,
...
int cl_object_compare_to(const cl_object_t *ob1,
...
cl_object_t *cl_object_create_with_spec(enum cl_type type,
    cl_spec_t *spec)
{
    cl_object_s *o = NULL;
