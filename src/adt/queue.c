...
cl_queue_node_t *cl_queue_at(const cl_queue_t *queue,
    unsigned int index)
{
...
int cl_queue_indexof(const cl_queue_t *queue, void *element,
    unsigned int size)
{
...
bool cl_queue_contains(const cl_queue_t *queue, void *element,
    unsigned int size)
{
