...
int cl_stack_push(cl_stack_t *stack, const void *node_content,
    unsigned int size)
{
...
cl_stack_node_t *cl_stack_at(const cl_stack_t *stack,
    unsigned int index)
{
...
int cl_stack_indexof(const cl_stack_t *stack, void *element,
    unsigned int size)
{
...
bool cl_stack_contains(const cl_stack_t *stack, void *element,
    unsigned int size)
{
